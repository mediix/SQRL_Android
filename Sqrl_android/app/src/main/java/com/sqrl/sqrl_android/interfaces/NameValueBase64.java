...
public abstract class NameValueBase64 {
    ...
    public String getValueBase64url() {return Base64.encodeToString(value.getBytes(), Base64.URL_SAFE);};

    /**
     *
     * @return return name={base64url(value)}
     */
    public String getNameValueBase64url() {return name+"={"+getValueBase64url()+"}";};
